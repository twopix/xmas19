var $visualizers = document.querySelector('.visualizer>div')
...
function go () {
  playRunner = setInterval(function () {
    ...
    $visualizers.each(function () {
      document.querySelector(this).css('height', Math.random() * 90 + 10 + '%')
    })
    // progress bar
    percentage += 0.15
...
document.querySelector('.play-button').on('click', function () {
...
document.querySelector('.progress-bar').on('click', function (e) {
